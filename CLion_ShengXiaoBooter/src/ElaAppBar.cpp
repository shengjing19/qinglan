...
Q_PROPERTY_CREATE_Q_CPP(ElaAppBar, bool, useSystemAppBar)
    ...
    : QWidget{parent}, d_ptr(new ElaAppBarPrivate())
{
    ...
    d->_routeBackButton->setFixedSize(0, 0);
    ...
    d->_stayTopButton->setFixedSize(0, 0);
    ...
    d->_titleLabel->setTextPixelSize(14);
    ...
    else
    {
        ...
        d->_titleLabelLayout->setContentsMargins(10, 4, 0, 0);
    }
